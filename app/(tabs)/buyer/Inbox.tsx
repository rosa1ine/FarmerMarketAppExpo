...
const Inbox = () => {
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity
      ...
      onPress={() => navigateToChat(item.receiver, item.receiver_profile.name)}
    >
      ...
      <View style={styles.textContainer}>
        <Text style={styles.name}>{item.sender_profile?.name || 'You'}</Text>
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Text style={styles.header}>Buyer's Inbox</Text>
        {loading ? (
