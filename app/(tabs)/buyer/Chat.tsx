...
const Chat = () => {
  ...
  useEffect(() => {
    console.log('Receiver ID:', receiver, 'Receiver Name:', name);
  }, [receiver, name]);
  ...
  useEffect(() => {
    const fetchSenderId = async () => {
      try {
        ...
        if (storedSenderId) {
          console.log('Fetched senderId from AsyncStorage:', storedSenderId);
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      if (!senderId) {
        console.log('Sender ID not set, skipping fetchMessages.');
        return;
      }
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (data.sender && !senderId) {
          console.log('Saving senderId to AsyncStorage:', data.sender);
